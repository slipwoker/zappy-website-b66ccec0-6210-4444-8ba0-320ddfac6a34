    ...
    if (contactForm) {
        ...
        const validators = {
            ...
            phone: (value) => {
                ...
                if (value.replace(/[^0-9]/g, '').length < 7) return 'Phone number must have at least 7 digits';
                return '';
            },
            message: (value) => {
            ...
            if (isValid) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; text-align: center;';
                ...
                .catch(() => {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b66ccec0-6210-4444-8ba0-320ddfac6a34',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b66ccec0-6210-4444-8ba0-320ddfac6a34';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b66ccec0-6210-4444-8ba0-320ddfac6a34';
